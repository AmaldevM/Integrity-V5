...
interface SidebarProps {
    ...
    onLogout: () => void;
    onInstallApp: () => void;
    // Restored Mobile Responsiveness Props
    isOpen?: boolean;
    onClose?: () => void;
}
    ...
    const NavItem = ({ id, icon: Icon, label, badge }: any) => {
        ...
        return (
            <button
                ...
                className={`flex items-center w-full px-3 py-3 rounded-lg mb-1 transition-all duration-200 group ${
                    isActive
    ...
    return (
        <>
            ...
            >
                ...
                <nav className="mt-2 space-y-0.5 px-3 pb-6 flex-1 overflow-y-auto scrollbar-hide relative z-10">
