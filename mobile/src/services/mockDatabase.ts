...
import { getAuth, signInWithEmailAndPassword, signOut as firebaseSignOut, onAuthStateChanged, Auth, initializeAuth, getReactNativePersistence } from "firebase/auth";
...
try {
    ...
    // auth = getAuth(app); // Replaced with initializeAuth for persistence
